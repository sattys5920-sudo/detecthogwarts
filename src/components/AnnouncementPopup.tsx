...
export default function AnnouncementPopup() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink-black/60 px-6" role="alertdialog" aria-modal="true">
      <div className="deckle-edge relative w-full max-w-xs border border-seal-500/40 bg-paper-50 p-5 text-center shadow-[0_4px_20px_rgba(23,19,15,0.35)]">
        ...
        <button
          type="button"
          onClick={dismiss}
          className="tablet-btn tablet-btn-dark mt-5 w-full px-4 py-2 text-xs font-bold"
        >
          확인
        </button>
      </div>
