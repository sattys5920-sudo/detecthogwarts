    ...
    sceneItems: [
      {
        ...
        icon: '💀',
        name: '시체',
        text: '11학년 에드먼드 엘리오. 외상은 크지 않지만, 이미 숨이 끊긴 지 오래다. 표정은 놀란 듯 굳어 있다.',
      ...
      },
      {
        ...
        icon: '🕯️',
        name: '낯선 문장',
        text: '시신 옆 바닥에 낯선 문장이 그려져 있다. 지금 학교의 어느 기숙사와도 일치하지 않는다.',
      ...
      },
      {
        ...
        icon: '🖋️',
        name: '적혀 있는 이름',
        text: '문장 옆에 손글씨로 "ARCADIA"라는 이름이 적혀 있다. 에드먼드가 마지막으로 남긴 것처럼 보인다.',
      ...
      },
      {
        ...
        icon: '🎒',
        name: '소지품',
        text: '가방 안은 뒤진 흔적이 있다. 노트와 필기구는 남아 있지만, 최근 그가 항상 들고 다니던 서류철은 보이지 않는다.',
